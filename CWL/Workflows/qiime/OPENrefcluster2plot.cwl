...
doc: |
    ...
    The workflow calls open reference otus and assigns taxa using greengenes. The output are taxa plots. 
...
steps:
    ...
    cluster:
        ...
        run: ../../Tools/qiime/pick_open_reference_otus.cwl
        in:
            fasta: fasta-demultiplexed
